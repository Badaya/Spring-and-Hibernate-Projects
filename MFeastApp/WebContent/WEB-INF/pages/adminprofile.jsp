    ...
    <div id="wrapper">
                ...
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        <li>
                         ...
                         <li>
                            <a href="surveyDetail"><i class="fa fa-table fa-fw"></i> Survey Details</a>
                        </li>
       ...
       <form:form action="profile" role="form" method="post" commandName="contactDetail" enctype="multipart/form-data">
                <div class="form-group">
                    ...
                    <form:input type="text" class="form-control"  value="" path="mobileNumber" data-placeholder="enter your new number"></form:input>
                </div>
                <div class="form-group">
                    <b>Permanent Address:</b>
                    <form:textarea class="form-control" rows="3"  path="permenantAddress" data-placeholder="enter your new Permanent Address"/>
                   
                </div>
                <div class="form-group">
                    <b>Temporary Address:</b>
                    <form:textarea class="form-control" rows="3"  path="temporaryAddress" data-placeholder="enter your new Temperory Address" />
                </div> 
                <div class="form-group">
