...
<link rel="stylesheet" type="text/css"
	href="resources/css/frontierCalendar/jquery-frontier-cal-1.3.2.css" />
...
<link rel="stylesheet" type="text/css"
	href="resources/css/jquery-ui/smoothness/jquery-ui-1.8.1.custom.css" />


<script type="text/javascript"
	src="resources/js/jquery-core/jquery-1.4.2-ie-fix.min.js"></script>


<script type="text/javascript"
	src="resources/js/jquery-ui/smoothness/jquery-ui-1.8.1.custom.min.js"></script>


<script type="text/javascript"
	src="resources/js/colorpicker/colorpicker.js"></script>


<script type="text/javascript"
	src="resources/js/jquery-qtip-1.0.0-rc3140944/jquery.qtip-1.0.js"></script>
...
<script type="text/javascript"
	src="resources/js/frontierCalendar/jquery-frontier-cal-1.3.2.min.js"></script>
		...
		$(document)
				.ready(
						function() {
							 ...
							 */
							function myAgendaDragStart(eventObj, divElm,
									agendaItem) {
							 ...
							 */
							function myAgendaDragStop(eventObj, divElm,
									agendaItem) {
								//alert("drag stop");
							}
							;
							...
							$("#BtnPreviousMonth")
									.click(
											function() {
												jfcalplugin
														.showPreviousMonth("#mycal");
												// update the jqeury datepicker value
												var calDate = jfcalplugin
														.getCurrentDate("#mycal"); // returns Date object
												var cyear = calDate
														.getFullYear();
									...
									.dialog(
											{
												...
												close : function() {
													...
													$("#startDate").val("");
													$("#endDate").val("");
													$("#startHour option:eq(0)")
															.attr("selected",
																	"selected");
													$("#startMin option:eq(0)")
															.attr("selected",
																	"selected");
													$(
															"#startMeridiem option:eq(0)")
															.attr("selected",
																	"selected");
													$("#endHour option:eq(0)")
															.attr("selected",
	...
	<div id="tabs">
		...
		<div id="tabs-2">
			...
			<div id="example" style="margin: auto; width: 80%;">
				<h1>Click the calendar to add some agenda items.</h1>
				<br>

				<div class="shadow" style="border: 1px solid #aaaaaa; padding: 3px;">
					<b style="font-size: 16px;"> <!--  <a href="homePage" type="button" id="goBack">Go To Home Page</button> -->
						<br>
				</div>
				<div id="toolbar" class="ui-widget-header ui-corner-all"
					...
					&nbsp;&nbsp;&nbsp; Date: <input type="text" id="dateSelect"
						size="20" /> &nbsp;&nbsp;&nbsp;
				...
				<form>
					<fieldset>
						...
						<table style="width: 100%; padding: 5px;">
							...
							<tr>
								<td><label>End Date</label> <input type="text"
